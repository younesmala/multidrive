...
urlpatterns = [
    ...
    path("update-bank/", views.update_bank, name="update_bank"),
    ...
    path("reservation/<int:reservation_id>/non-presentation/", views.mark_nopresentation, name="mark_nopresentation"),
